...
const programs = [
  {
    ...
    description:
      "A protected worksheet hub with drawing, text, eraser, upload, and export tools.",
    icon: BookOpenCheck,
    title: "Learning Hub",
  },
  {
    ...
    description:
      "Personalised printable packs for parents who want child-specific practice.",
    icon: FileText,
  ...
  },
  {
    ...
    description:
      "Flashcards and modules that make revision simple, visual, and joyful.",
    icon: Layers3,
...
export default function Home() {
  return (
    <main className="premium-page-bg min-h-screen text-[var(--fd-blue)]">
      ...
      <section className="relative overflow-hidden">
        ...
        <header className="absolute inset-x-0 top-0 z-30 border-b border-white/70 bg-white/82 shadow-[0_12px_40px_rgba(56,66,130,0.08)] backdrop-blur-xl">
          ...
          <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4 md:px-8">
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center rounded-lg border border-white/80 bg-white/90 px-5 py-2.5 text-sm font-black text-[var(--fd-blue)] shadow-[0_8px_20px_rgba(56,66,130,0.08)] backdrop-blur transition hover:-translate-y-0.5 hover:bg-white"
            >
              <span className="font-kindergarten text-base">
                Sign In
              </span>
            </Link>
        ...
        <div className="relative z-10 mx-auto grid min-h-[86vh] max-w-7xl content-center px-5 pb-20 pt-28 md:px-8">
          ...
          <div className="max-w-4xl">
            ...
            <p className="font-kindergarten mt-6 max-w-2xl text-xl leading-8 text-[#4c57a9] md:text-2xl">
              A cheerful paid learning portal for parents and children,
              with protected access, profile management, worksheet
              activities, flashcards, and custom learning packs.
            </p>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              ...
              >
                <span className="font-kindergarten text-lg">
                  Register Now
                </span>
            ...
            <div className="mt-10 grid max-w-3xl grid-cols-2 gap-3 md:grid-cols-4">
              ...
              {[
                ...
                <div
                  key={label}
                  className="premium-card-shadow rounded-lg border border-white/85 bg-white/82 p-4 backdrop-blur"
                >

                  <p className="font-blank-space text-3xl text-[var(--fd-blue)]">
                    {value}
                  </p>

                  <p className="font-kindergarten mt-1 text-sm text-[#6698cc]">
                    {label}
                  </p>
      ...
      >
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          ...
          <div>
            ...
            <p className="font-kindergarten text-lg text-[var(--fd-green)]">
          ...
          <p className="font-kindergarten max-w-md text-xl leading-7 text-[#4c57a9]">
            Each account gets access based on the package selected during
            registration. Locked sections stay protected until purchase.
          </p>
          ...
          {programs.map((program) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`grid size-12 place-items-center rounded-lg ${program.accent}`}
                >
                  <Icon
                    size={24}
                    aria-hidden="true"
                ...
                <h3 className="font-kindergarten mt-6 text-3xl text-[var(--fd-blue)]">
                  {program.title}
                </h3>

                <p className="font-kindergarten mt-3 text-lg leading-6 text-[#4c57a9]">
                  {program.description}
                </p>
      ...
      <section
        id="worksheet"
        className="bg-[linear-gradient(135deg,var(--fd-blue)_0%,#5e559f_54%,#3f7d73_100%)] py-16 text-white shadow-[inset_0_24px_60px_rgba(255,255,255,0.08)] md:py-24"
      >
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 md:grid-cols-[0.85fr_1.15fr] md:px-8">
          ...
          <div>
            ...
            <p className="font-kindergarten text-lg text-[var(--fd-yellow)]">
              Built for finger, mouse, and stylus
            </p>
            ...
            <p className="font-kindergarten mt-5 text-xl leading-8 text-white/82">
              Children can draw, erase, type, upload worksheet backgrounds,
              undo, redo, clear the canvas, and save their work as an image
              or PDF.
            </p>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            {[
              ...
              const IconComponent =
                Icon as typeof WandSparkles;

              return (
                <div
                  key={label as string}
                  className="rounded-lg border border-white/18 bg-white/12 p-5 shadow-[0_18px_45px_rgba(0,0,0,0.12)] backdrop-blur"
                >

                  <IconComponent
                    size={24}
                    className="text-[var(--fd-yellow)]"
                    aria-hidden="true"
                  />

                  <p className="font-kindergarten mt-4 text-2xl">
                    {label as string}
                  </p>
      ...
      <section
        id="access"
        className="mx-auto grid max-w-7xl gap-10 px-5 py-16 md:grid-cols-[1fr_0.85fr] md:px-8 md:py-24"
      >

        <div>

          <p className="font-kindergarten text-lg text-[var(--fd-red)]">
          ...
          <p className="font-kindergarten mt-5 max-w-2xl text-xl leading-8 text-[#4c57a9]">
            Parents can choose the right learning section for their child.
            Each area opens only when it is included in the selected package.
          </p>
          ...
          <div className="mt-7 grid gap-3 sm:grid-cols-2">
            ...
            {premiumDetails.map((item) => (
              ...
              <div
                key={item}
                className="premium-card-shadow flex items-start gap-3 rounded-lg bg-white/88 p-4"
              >

                <CheckCircle2
                  size={20}
                  className="mt-0.5 shrink-0 text-[var(--fd-green)]"
                  aria-hidden="true"
                />

                <p className="font-kindergarten text-lg leading-6">
                  {item}
                </p>
        ...
        <aside className="premium-card-shadow rounded-lg border border-white/85 bg-white/90 p-6">
          ...
          <div className="mb-6 flex items-center justify-between">
            ...
            <div>
              ...
              <h3 className="font-blank-space mt-1 text-4xl">
                Parent journey
              </h3>
          ...
          <div className="space-y-3">
            ...
            {steps.map((step, index) => (
              ...
              <div
                key={step}
                className="flex items-center gap-3 rounded-lg bg-[var(--fd-cream)] p-4"
              >
                ...
                <span className="font-kindergarten text-xl text-[var(--fd-blue)]">
                  {step}
                </span>
